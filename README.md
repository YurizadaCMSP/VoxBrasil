# VoxBrasil
[Original repository](https://github.com/CyberMor/sampvoice) | [Русский](https://github.com/AmyrAhmady/sampvoice/blob/master/README.ru.md)

## Description
---------------------------------
VoxBrasil is a Brazilian voice communication system for SA-MP and open.mp servers.

Original creator: CyberMor
Fork original: Amyr Ahmady
Project VoxBrasil: Yuri

Based on the SampVoice project.

Release format: VoxBrasil 1.0.0
Client archive: VoxBrasil-Client.zip
Server archive: VoxBrasil-Server.zip
...
##### Automatically
---------------------------------
1. In order to download the installer, head over to [the `releases` page](https://github.com/Yuri/VoxBrasil/releases) and choose the desired version of the plugin.
...
##### Manually
---------------------------------
1. Head over [the `releases` page](https://github.com/Yuri/VoxBrasil/releases) and download the archive with the desired client version.
2. Extract the archive to your GTA San Andreas folder.

#### For developers
---------------------------------
1. Download from [the `releases` page](https://github.com/Yuri/VoxBrasil/releases) the desired version of the plugin for your platform.
2. Unpack the archive to the root directory of the server.
3. Add to the *server.cfg* server configuration file the line *"plugins voxbrasil"* for *Win32* and *"plugins voxbrasil.so"* for *Linux x86*. **(If you have a Pawn.RakNet plugin be sure to place VoxBrasil after it)**
...
> Note: the Pawn include file remains `sampvoice.inc` in this first version for compatibility.
...
```sh
git clone https://github.com/Yuri/VoxBrasil.git
